...
export class EntityResult extends jspb.Message {
  ...
  setEntity(value?: google_datastore_v1beta3_entity_pb.Entity): EntityResult;
  hasEntity(): boolean;
...
export class PropertyFilter extends jspb.Message {
  ...
  setValue(value?: google_datastore_v1beta3_entity_pb.Value): PropertyFilter;
  hasValue(): boolean;
...
export class GqlQueryParameter extends jspb.Message {
  getValue(): google_datastore_v1beta3_entity_pb.Value | undefined;
  setValue(value?: google_datastore_v1beta3_entity_pb.Value): GqlQueryParameter;
  hasValue(): boolean;
