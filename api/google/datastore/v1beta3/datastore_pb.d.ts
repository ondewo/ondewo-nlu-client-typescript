...
export class LookupRequest extends jspb.Message {
  ...
  setKeysList(value: Array<google_datastore_v1beta3_entity_pb.Key>): LookupRequest;
...
export class LookupResponse extends jspb.Message {
  ...
  setFoundList(value: Array<google_datastore_v1beta3_query_pb.EntityResult>): LookupResponse;
  ...
  setMissingList(value: Array<google_datastore_v1beta3_query_pb.EntityResult>): LookupResponse;
  ...
  setDeferredList(value: Array<google_datastore_v1beta3_entity_pb.Key>): LookupResponse;
...
export class RunQueryRequest extends jspb.Message {
  ...
  setPartitionId(value?: google_datastore_v1beta3_entity_pb.PartitionId): RunQueryRequest;
  ...
  setQuery(value?: google_datastore_v1beta3_query_pb.Query): RunQueryRequest;
  hasQuery(): boolean;
  clearQuery(): RunQueryRequest;

  getGqlQuery(): google_datastore_v1beta3_query_pb.GqlQuery | undefined;
  setGqlQuery(value?: google_datastore_v1beta3_query_pb.GqlQuery): RunQueryRequest;
  hasGqlQuery(): boolean;
...
export class RunQueryResponse extends jspb.Message {
  ...
  setBatch(value?: google_datastore_v1beta3_query_pb.QueryResultBatch): RunQueryResponse;
  hasBatch(): boolean;
  clearBatch(): RunQueryResponse;

  getQuery(): google_datastore_v1beta3_query_pb.Query | undefined;
  setQuery(value?: google_datastore_v1beta3_query_pb.Query): RunQueryResponse;
  hasQuery(): boolean;
...
export class AllocateIdsRequest extends jspb.Message {
  ...
  getKeysList(): Array<google_datastore_v1beta3_entity_pb.Key>;
  setKeysList(value: Array<google_datastore_v1beta3_entity_pb.Key>): AllocateIdsRequest;
...
export class AllocateIdsResponse extends jspb.Message {
  getKeysList(): Array<google_datastore_v1beta3_entity_pb.Key>;
  setKeysList(value: Array<google_datastore_v1beta3_entity_pb.Key>): AllocateIdsResponse;
...
export class ReserveIdsRequest extends jspb.Message {
  ...
  getKeysList(): Array<google_datastore_v1beta3_entity_pb.Key>;
  setKeysList(value: Array<google_datastore_v1beta3_entity_pb.Key>): ReserveIdsRequest;
...
export class Mutation extends jspb.Message {
  ...
  setInsert(value?: google_datastore_v1beta3_entity_pb.Entity): Mutation;
  hasInsert(): boolean;
  clearInsert(): Mutation;

  getUpdate(): google_datastore_v1beta3_entity_pb.Entity | undefined;
  setUpdate(value?: google_datastore_v1beta3_entity_pb.Entity): Mutation;
  hasUpdate(): boolean;
  clearUpdate(): Mutation;

  getUpsert(): google_datastore_v1beta3_entity_pb.Entity | undefined;
  setUpsert(value?: google_datastore_v1beta3_entity_pb.Entity): Mutation;
  hasUpsert(): boolean;
  clearUpsert(): Mutation;

  getDelete(): google_datastore_v1beta3_entity_pb.Key | undefined;
  setDelete(value?: google_datastore_v1beta3_entity_pb.Key): Mutation;
  hasDelete(): boolean;
...
export class MutationResult extends jspb.Message {
  ...
  setKey(value?: google_datastore_v1beta3_entity_pb.Key): MutationResult;
  hasKey(): boolean;
