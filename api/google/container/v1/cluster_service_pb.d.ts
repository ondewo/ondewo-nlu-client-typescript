...
export class LegacyAbac extends jspb.Message {
  getEnabled(): boolean;
  setEnabled(value: boolean): LegacyAbac;
...
export class Cluster extends jspb.Message {
  ...
  clearResourceLabelsMap(): Cluster;

  getLabelFingerprint(): string;
  setLabelFingerprint(value: string): Cluster;

  getLegacyAbac(): LegacyAbac | undefined;
  setLegacyAbac(value?: LegacyAbac): Cluster;
  hasLegacyAbac(): boolean;
  clearLegacyAbac(): Cluster;
