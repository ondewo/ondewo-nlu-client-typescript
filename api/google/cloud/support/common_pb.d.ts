...
export class SupportAccount extends jspb.Message {
  ...
  clearCreateTime(): SupportAccount;
...
export class Case extends jspb.Message {
  ...
  clearCcAddressesList(): Case;
  addCcAddresses(value: string, index?: number): Case;
...
export class IssueTaxonomy extends jspb.Message {
  ...
  clearCategoriesMap(): IssueTaxonomy;
...
export namespace IssueTaxonomy {
  ...
  export class Component extends jspb.Message {
    ...
    clearLanguagesList(): Component;
    addLanguages(value: string, index?: number): Component;
    ...
    clearSubcomponentsList(): Component;
