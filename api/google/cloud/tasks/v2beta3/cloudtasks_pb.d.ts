...
export class ListQueuesResponse extends jspb.Message {
  ...
  setQueuesList(value: Array<google_cloud_tasks_v2beta3_queue_pb.Queue>): ListQueuesResponse;
...
export class CreateQueueRequest extends jspb.Message {
  ...
  setQueue(value?: google_cloud_tasks_v2beta3_queue_pb.Queue): CreateQueueRequest;
  hasQueue(): boolean;
...
export class UpdateQueueRequest extends jspb.Message {
  getQueue(): google_cloud_tasks_v2beta3_queue_pb.Queue | undefined;
  setQueue(value?: google_cloud_tasks_v2beta3_queue_pb.Queue): UpdateQueueRequest;
  hasQueue(): boolean;
...
export class ListTasksRequest extends jspb.Message {
  ...
  setResponseView(value: google_cloud_tasks_v2beta3_task_pb.Task.View): ListTasksRequest;
...
export class ListTasksResponse extends jspb.Message {
  ...
  setTasksList(value: Array<google_cloud_tasks_v2beta3_task_pb.Task>): ListTasksResponse;
...
export class GetTaskRequest extends jspb.Message {
  ...
  getResponseView(): google_cloud_tasks_v2beta3_task_pb.Task.View;
  setResponseView(value: google_cloud_tasks_v2beta3_task_pb.Task.View): GetTaskRequest;
...
export class CreateTaskRequest extends jspb.Message {
  ...
  setTask(value?: google_cloud_tasks_v2beta3_task_pb.Task): CreateTaskRequest;
  hasTask(): boolean;
  clearTask(): CreateTaskRequest;

  getResponseView(): google_cloud_tasks_v2beta3_task_pb.Task.View;
  setResponseView(value: google_cloud_tasks_v2beta3_task_pb.Task.View): CreateTaskRequest;
...
export class RunTaskRequest extends jspb.Message {
  ...
  getResponseView(): google_cloud_tasks_v2beta3_task_pb.Task.View;
  setResponseView(value: google_cloud_tasks_v2beta3_task_pb.Task.View): RunTaskRequest;
