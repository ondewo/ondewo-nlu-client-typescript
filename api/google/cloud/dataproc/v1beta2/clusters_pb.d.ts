...
export class ClusterConfig extends jspb.Message {
  ...
  setLifecycleConfig(value?: LifecycleConfig): ClusterConfig;
  hasLifecycleConfig(): boolean;
  clearLifecycleConfig(): ClusterConfig;
...
export class InstanceGroupConfig extends jspb.Message {
  ...
  setMinCpuPlatform(value: string): InstanceGroupConfig;
...
export class DiskConfig extends jspb.Message {
  ...
  setBootDiskType(value: string): DiskConfig;
...
export class LifecycleConfig extends jspb.Message {
  ...
  setIdleDeleteTtl(value?: google_protobuf_duration_pb.Duration): LifecycleConfig;
  hasIdleDeleteTtl(): boolean;
  clearIdleDeleteTtl(): LifecycleConfig;

  getAutoDeleteTime(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setAutoDeleteTime(value?: google_protobuf_timestamp_pb.Timestamp): LifecycleConfig;
  hasAutoDeleteTime(): boolean;
  clearAutoDeleteTime(): LifecycleConfig;

  getAutoDeleteTtl(): google_protobuf_duration_pb.Duration | undefined;
  setAutoDeleteTtl(value?: google_protobuf_duration_pb.Duration): LifecycleConfig;
  hasAutoDeleteTtl(): boolean;
  clearAutoDeleteTtl(): LifecycleConfig;
...
export class UpdateClusterRequest extends jspb.Message {
  ...
  setGracefulDecommissionTimeout(value?: google_protobuf_duration_pb.Duration): UpdateClusterRequest;
  hasGracefulDecommissionTimeout(): boolean;
  clearGracefulDecommissionTimeout(): UpdateClusterRequest;
...
export class DeleteClusterRequest extends jspb.Message {
  ...
  getClusterUuid(): string;
  setClusterUuid(value: string): DeleteClusterRequest;
