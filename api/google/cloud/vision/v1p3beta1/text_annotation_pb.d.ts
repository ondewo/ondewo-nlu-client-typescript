...
export class Block extends jspb.Message {
  ...
  setBoundingBox(value?: google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly): Block;
...
export class Paragraph extends jspb.Message {
  ...
  getBoundingBox(): google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly | undefined;
  setBoundingBox(value?: google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly): Paragraph;
  hasBoundingBox(): boolean;
...
export class Word extends jspb.Message {
  ...
  getBoundingBox(): google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly | undefined;
  setBoundingBox(value?: google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly): Word;
  hasBoundingBox(): boolean;
...
export class Symbol extends jspb.Message {
  ...
  getBoundingBox(): google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly | undefined;
  setBoundingBox(value?: google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly): Symbol;
  hasBoundingBox(): boolean;
