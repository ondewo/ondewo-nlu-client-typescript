...
export class FaceAnnotation extends jspb.Message {
  ...
  setBoundingPoly(value?: google_cloud_vision_v1_geometry_pb.BoundingPoly): FaceAnnotation;
  ...
  setFdBoundingPoly(value?: google_cloud_vision_v1_geometry_pb.BoundingPoly): FaceAnnotation;
...
export namespace FaceAnnotation {
  ...
  export class Landmark extends jspb.Message {
    ...
    setPosition(value?: google_cloud_vision_v1_geometry_pb.Position): Landmark;
    hasPosition(): boolean;
...
export class EntityAnnotation extends jspb.Message {
  ...
  getBoundingPoly(): google_cloud_vision_v1_geometry_pb.BoundingPoly | undefined;
  setBoundingPoly(value?: google_cloud_vision_v1_geometry_pb.BoundingPoly): EntityAnnotation;
  hasBoundingPoly(): boolean;
...
export class LocalizedObjectAnnotation extends jspb.Message {
  ...
  getBoundingPoly(): google_cloud_vision_v1_geometry_pb.BoundingPoly | undefined;
  setBoundingPoly(value?: google_cloud_vision_v1_geometry_pb.BoundingPoly): LocalizedObjectAnnotation;
  hasBoundingPoly(): boolean;
...
export class CropHint extends jspb.Message {
  getBoundingPoly(): google_cloud_vision_v1_geometry_pb.BoundingPoly | undefined;
  setBoundingPoly(value?: google_cloud_vision_v1_geometry_pb.BoundingPoly): CropHint;
  hasBoundingPoly(): boolean;
...
export class AnnotateImageResponse extends jspb.Message {
  ...
  setFullTextAnnotation(value?: google_cloud_vision_v1_text_annotation_pb.TextAnnotation): AnnotateImageResponse;
  ...
  setWebDetection(value?: google_cloud_vision_v1_web_detection_pb.WebDetection): AnnotateImageResponse;
